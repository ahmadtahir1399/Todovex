...
const FeatureCard = ({ title = 0 }) => {
  return (
    <Card className="group relative overflow-hidden bg-gradient-to-br from-purple-500/10 to-blue-500/10 backdrop-blur-md border-none h-48 transition-all duration-300 hover:scale-105">
